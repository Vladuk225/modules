...
🎮 <b>Готовы сыграть в "Русская рулетка"?</b>
...
async def callback_russian_roulette_yes(callback: types.CallbackQuery):
...
async def callback_russian_roulette_no(callback: types.CallbackQuery):
...
def register_handlers(dp: Dispatcher):
    dp.register_message_handler(russian_roulette, lambda message: message.text.lower().startswith('русская рулетка'))
